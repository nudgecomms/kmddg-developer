<?php
	...
	$whereClause = "WHERE team = 'BS' and isDeleted = 'N' ";

	if($loginUserIsMaster == 'Y'){
		$whereClause .= " and isMaster = 'N'";
	}else{
		if($loginUserIsAdmin == 'Y'){
			$whereClause .= " and bsChargeId = '$loginUserId'";
		}else{
...
?>
	<body class="page page-id-04 staff">
				...
				<table class="sales_staff_table">
					<thead>
						<tr>
							...
							<th class="table-list-sales_manager">영업 관리자</th>
							<th class="table-list-sales_staff">직원</th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="table-list-sales_manager"><?php echo $row['bsChargeId'] ?? '-'; ?></td>
							<td class="table-list-sales_staff">-</td>
							...
							<td class="table-list-management">
								<a href="#" 
									...
									data-bschargeid="<?php echo $row['bsChargeId']; ?>"
									data-team="sales"
								>
		...
		<?php include_once "../common/popup_staff_bs_manager.php"; ?>
	</body>
</html>
<script>
